-- ============================================================
-- Freemopay Integration - Transactions
-- Table pour gérer l'historique des paiements Freemopay
-- Note: La config est dans app_settings avec la clé 'freemopay_config'
-- ============================================================
